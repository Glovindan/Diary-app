...
class EventController {
  async createEvent(req, res) {
    ...
    const newEvent = await db.query(
      `INSERT INTO event (type, begin_timestamp, end_timestamp, place, topic) VALUES($1, $2, $3, $4, $5)`,
  ...
  async getEvents(req, res) {
    ...
    const events = await db.query('SELECT * FROM event' + filterQueryString + ' ORDER BY begin_timestamp' + limitQueryString + offsetQueryString);
